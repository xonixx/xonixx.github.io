...
Using the same conversion technique I was able to convert a couple more bytebeats from C to GAWK: 
```
...
If you are on Linux, you can try each of them straight in the command line.
...
The other learning was that I needed to add `-C` flag to `hexdump`, otherwise [due to endiannes](https://unix.stackexchange.com/a/55772/52083) inconsistency it was swapping the bytes in the text output.   
...
So according to this C is roughly **210x** times faster than GAWK `¯\_(ツ)_/¯`
...
I enjoyed the wonderful bytebeats - tiny C programs producing sounds and even melodies.
