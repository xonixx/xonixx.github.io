...
In addition to the refactoring opportunities mentioned above this also allowed to [improve a bit](https://github.com/xonixx/makesure/commit/7a15ad9bcd43aefd70f329c35132a83ea9b1117c) the own `Makesurefile` of the project! Yes, [we eat our own dog food](https://en.wikipedia.org/wiki/Eating_your_own_dog_food).
